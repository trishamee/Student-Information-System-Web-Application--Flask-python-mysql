...
#change course options later
    course_code = SelectField('Course', [validators.DataRequired()], choices = available_courses)
...
#change course options later
    college_code = SelectField('College Code', [validators.DataRequired()], choices =['CCS','CSM'])
    submit = SubmitField("Submit")
